...
RAW_STUDENTS_DATA = [
    ...
    },
    {
        ...
        "course_name": "Product Design & CNC Machine",
        "year_sem": None,
    ...
    {
        "source_image": "IMG_3092.png",
        "has_photo": True,
        "crop_box_ratios": [0.708, 0.150, 0.858, 0.278],
        "name": "Zaheer Khan",
        "father_name": "Mohammed Irfan",
        "mother_name": "Zarina Bano",
        "dob": "2002-12-26",
        "father_occupation": None,
        "college_school": None,
        "course_name": "Master Architecture",
        "year_sem": None,
        "mobile_no": "9602743517",
        "email": "zaheerkhan9602743517@gmail.com",
        "father_contact_no": "9521833676",
        "alternate_contact_no": None,
        "permanent_address": "Khood, Sikar",
        "district": "Sikar",
        "state": "Rajasthan",
        "pin_code": "332316",
        "aadhar_no": "904469411629",
        "status": "Active",
        "admission_date": "2024-03-28",
        "is_online": False,
        "online_reg_no": "Master 28/3/24",
        "total_fee": 120000.0,
        "discount_amount": 0.0,
        "net_fee": 120000.0,
        "installments": [
            {"installment_no": 1, "installment_label": "1st", "due_amount": 120000.0, "paid_amount": 10000.0, "due_date": "2023-07-13", "payment_date": "2023-07-13", "payment_mode": "Cash"},
            {"installment_no": 2, "installment_label": "2nd", "due_amount": 110000.0, "paid_amount": 20000.0, "due_date": "2023-10-05", "payment_date": "2023-10-05", "payment_mode": "Cash"},
            {"installment_no": 3, "installment_label": "3rd", "due_amount": 90000.0, "paid_amount": 10000.0, "due_date": "2024-03-21", "payment_date": "2024-03-21", "payment_mode": "Cash"},
            {"installment_no": 4, "installment_label": "4th", "due_amount": 80000.0, "paid_amount": 10000.0, "due_date": "2024-07-08", "payment_date": "2024-07-08", "payment_mode": "Cash"},
            {"installment_no": 5, "installment_label": "5th", "due_amount": 70000.0, "paid_amount": 0.0, "due_date": "2025-05-01", "payment_mode": "Cash"},
        ]
    },
    {
        "source_image": "IMG_3093.png",
        "has_photo": True,
        "crop_box_ratios": [0.718, 0.165, 0.895, 0.328],
        "name": "Chetan Jangir",
        "father_name": "Raju Ram Jangir",
        "mother_name": "Ranjana Devi",
        "dob": "2001-12-05",
        "father_occupation": "Farmer",
        "college_school": "Govt. ITI (Sikar)",
        "course_name": "Master Architecture",
        "year_sem": None,
        "mobile_no": "7300461661",
        "email": "chetankumarftr99@gmail.com",
        "father_contact_no": None,
        "alternate_contact_no": None,
        "permanent_address": "V.P.O - Dhandhan, Teh - Ramgarh Shekhawati",
        "district": "Sikar",
        "state": "Rajasthan",
        "pin_code": "332302",
        "aadhar_no": "447700383725",
        "status": "Active",
        "admission_date": "2023-09-07",
        "is_online": True,
        "online_reg_no": "Pro. CAD 25 Dec 23",
        "total_fee": 120000.0,
        "discount_amount": 0.0,
        "net_fee": 120000.0,
        "installments": [
            {"installment_no": 1, "installment_label": "1st", "due_amount": 120000.0, "paid_amount": 10000.0, "due_date": "2023-09-07", "payment_date": "2023-09-07", "payment_mode": "Cash"}
        ]
    },
    {
        "source_image": "IMG_3094.png",
        "has_photo": True,
        "crop_box_ratios": [0.748, 0.180, 0.925, 0.335],
        "name": "Jyoti Jangir",
        "father_name": "Shishpal Jangir",
        "mother_name": "Aarti Devi",
        "dob": "2001-07-01",
        "father_occupation": "Oman",
        "college_school": "Bhartiya B.Ed College, Sikar",
        "course_name": "Master Architecture",
        "year_sem": None,
        "mobile_no": "8005969996",
        "email": "jjangir869@gmail.com",
        "father_contact_no": "9950218869",
        "alternate_contact_no": None,
        "permanent_address": "Patoda, Sikar",
        "district": "Sikar",
        "state": "Rajasthan",
        "pin_code": "332312",
        "aadhar_no": "843442588327",
        "status": "Active",
        "admission_date": "2024-10-03",
        "is_online": True,
        "online_reg_no": "Hardika Shekhawat Replaced",
        "total_fee": 120000.0,
        "discount_amount": 0.0,
        "net_fee": 120000.0,
        "installments": [
            {"installment_no": 1, "installment_label": "1st", "due_amount": 120000.0, "paid_amount": 10000.0, "due_date": "2024-10-03", "payment_date": "2024-10-03", "payment_mode": "Cash"},
            {"installment_no": 2, "installment_label": "2nd", "due_amount": 110000.0, "paid_amount": 10000.0, "due_date": "2024-11-25", "payment_date": "2024-11-25", "payment_mode": "Cash"},
            {"installment_no": 3, "installment_label": "3rd", "due_amount": 100000.0, "paid_amount": 10000.0, "due_date": "2024-12-30", "payment_date": "2024-12-30", "payment_mode": "Cash"},
            {"installment_no": 4, "installment_label": "4th", "due_amount": 90000.0, "paid_amount": 10000.0, "due_date": "2025-01-28", "payment_date": "2025-01-28", "payment_mode": "Cash"}
        ]
    },
    {
        "source_image": "IMG_3095.png",
        "has_photo": True,
        "crop_box_ratios": [0.732, 0.165, 0.902, 0.315],
        "name": "Mohit Jangir",
        "father_name": "Makhan Lal Ji",
        "mother_name": "Manju Devi",
        "dob": "2004-12-04",
        "father_occupation": "Carpenter",
        "college_school": "B.Sc",
        "course_name": "Master Architecture",
        "year_sem": None,
        "mobile_no": "6367669703",
        "email": "MohitJAN7784@gmail.com",
        "father_contact_no": "9587097550",
        "alternate_contact_no": None,
        "permanent_address": "Kushalpura, Sikar",
        "district": "Sikar",
        "state": "Rajasthan",
        "pin_code": "332027",
        "aadhar_no": "966525045572",
        "status": "Active",
        "admission_date": "2024-02-27",
        "is_online": False,
        "online_reg_no": None,
        "total_fee": 120000.0,
        "discount_amount": 0.0,
        "net_fee": 120000.0,
        "installments": [
            {"installment_no": 1, "installment_label": "1st", "due_amount": 120000.0, "paid_amount": 35000.0, "due_date": "2024-02-27", "payment_date": "2024-02-27", "payment_mode": "Cash"},
            {"installment_no": 2, "installment_label": "2nd", "due_amount": 85000.0, "paid_amount": 20000.0, "due_date": "2024-09-19", "payment_date": "2024-09-19", "payment_mode": "Cash"},
            {"installment_no": 3, "installment_label": "3rd", "due_amount": 65000.0, "paid_amount": 0.0, "due_date": "2025-03-03", "payment_mode": "Cash"},
            {"installment_no": 4, "installment_label": "4th", "due_amount": 65000.0, "paid_amount": 0.0, "due_date": "2026-09-04", "payment_mode": "Cash"}
        ]
    },
    {
        "source_image": "IMG_3096.png",
        "has_photo": True,
        "crop_box_ratios": [0.730, 0.140, 0.902, 0.292],
        "name": "Ankit Jangir",
        "father_name": "Sanwarmal Jangir",
        "mother_name": "Manju Devi",
        "dob": "2002-11-16",
        "father_occupation": None,
        "college_school": "Goenka School (Laxmangarh)",
        "course_name": "Master Architecture",
        "year_sem": None,
        "mobile_no": "7849916629",
        "email": None,
        "father_contact_no": "7297033701",
        "alternate_contact_no": "8114458020",
        "permanent_address": "Singodari, Laxmangarh (Sikar)",
        "district": "Sikar",
        "state": "Rajasthan",
        "pin_code": "332311",
        "aadhar_no": "712647764041",
        "status": "Active",
        "admission_date": "2024-03-11",
        "is_online": True,
        "online_reg_no": "Same Ankit",
        "total_fee": 120000.0,
        "discount_amount": 0.0,
        "net_fee": 120000.0,
        "installments": [
            {"installment_no": 1, "installment_label": "1st", "due_amount": 120000.0, "paid_amount": 16000.0, "due_date": "2024-03-11", "payment_date": "2024-03-11", "payment_mode": "Cash"},
            {"installment_no": 2, "installment_label": "2nd", "due_amount": 104000.0, "paid_amount": 19000.0, "due_date": "2024-04-13", "payment_date": "2024-04-13", "payment_mode": "Cash"},
            {"installment_no": 3, "installment_label": "3rd", "due_amount": 85000.0, "paid_amount": 10000.0, "due_date": "2024-07-15", "payment_date": "2024-07-15", "payment_mode": "Cash"},
            {"installment_no": 4, "installment_label": "4th", "due_amount": 75000.0, "paid_amount": 5000.0, "due_date": "2024-10-09", "payment_date": "2024-10-09", "payment_mode": "Cash"},
            {"installment_no": 5, "installment_label": "5th", "due_amount": 70000.0, "paid_amount": 0.0, "due_date": "2025-02-22", "payment_mode": "Cash"},
            {"installment_no": 6, "installment_label": "6th", "due_amount": 70000.0, "paid_amount": 0.0, "due_date": "2025-04-11", "payment_mode": "Cash"},
            {"installment_no": 7, "installment_label": "7th", "due_amount": 70000.0, "paid_amount": 0.0, "due_date": "2025-07-16", "payment_mode": "Cash"}
        ]
    }
]
